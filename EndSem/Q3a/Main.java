...
public class Main {
    public static void main(String[] args) throws LimitsError, InterruptedException {
        ...
        Element_finderRunnable left = new Element_finderRunnable(0, mid, toFind, find_Element);
        Element_finderRunnable right = new Element_finderRunnable(mid + 1, find_Element.size(), toFind, find_Element);
